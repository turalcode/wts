...
const EmployeePage = () => {
  ...
  async function updateEmployeeHandler(event) {
    ...
    if (!name || !Number.isInteger(+employeeSalary) || +employeeSalary <= 0) {
              ...
              >
                ...
                <td className="px-6 py-4">
                  <MonthSalary
                    ...
                    setSalaryReportHandler={setSalaryReportHandler}
                  />
                </td>
                <td className="px-6 py-4">{report.month.salary} &#8381;</td>
                <td className="px-6 py-4">{report.month.overtime} &#8381;</td>
                <td className="px-6 py-4">{report.month.total} &#8381;</td>
              </tr>
            );
          })}
        </tbody>
